# Translate Cospend in your language
...
[Here](https://gitlab.com/eneiluj/cospend-nc/issues/new?issue%5Bassignee_id%5D=&issue%5Bmilestone_id%5D=) is the link to submit a new issue.
...
You can also submit a [new issue](https://gitlab.com/eneiluj/cospend-nc/issues/new?issue%5Bassignee_id%5D=&issue%5Bmilestone_id%5D=) to suggest a change or to make a feature request.
...
``` bash
git clone https://gitlab.com/yourlogin/cospend-nc cospend
cd cospend

# on your local master branch, to get changes from original project's master branch :
git pull https://gitlab.com/eneiluj/cospend-nc master
...
* Try not to make changes to libraries. Any css can be overriden in `css/cospend.css`
