...
return [
	'routes' => [
		...
		['name' => 'oldApi#apiCreateProject', 'url' => '/api/projects', 'verb' => 'POST'],
		['name' => 'oldApi#apiGetProjectInfo', 'url' => '/api/projects/{projectid}/{password}', 'verb' => 'GET'],
		['name' => 'oldApi#apiSetProjectInfo', 'url' => '/api/projects/{projectid}/{passwd}', 'verb' => 'PUT'],
		['name' => 'oldApi#apiDeleteProject', 'url' => '/api/projects/{projectid}/{password}', 'verb' => 'DELETE'],
		['name' => 'oldApi#apiGetMembers', 'url' => '/api/projects/{projectid}/{password}/members', 'verb' => 'GET'],
		['name' => 'oldApi#apiAddMember', 'url' => '/api/projects/{projectid}/{password}/members', 'verb' => 'POST'],
		['name' => 'oldApi#apiv2AddMember', 'url' => '/apiv2/projects/{projectid}/{password}/members', 'verb' => 'POST'],
		['name' => 'oldApi#apiEditMember', 'url' => '/api/projects/{projectid}/{password}/members/{memberid}', 'verb' => 'PUT'],
		['name' => 'oldApi#apiDeleteMember', 'url' => '/api/projects/{projectid}/{password}/members/{memberid}', 'verb' => 'DELETE'],
		['name' => 'oldApi#apiGetBills', 'url' => '/api/projects/{projectid}/{password}/bills', 'verb' => 'GET'],
		['name' => 'oldApi#apiAddBill', 'url' => '/api/projects/{projectid}/{password}/bills', 'verb' => 'POST'],
		['name' => 'oldApi#apiRepeatBill', 'url' => '/api/projects/{projectid}/{password}/bills/{billid}/repeat', 'verb' => 'GET'],
		['name' => 'oldApi#apiEditBill', 'url' => '/api/projects/{projectid}/{password}/bills/{billid}', 'verb' => 'PUT'],
		['name' => 'oldApi#apiEditBills', 'url' => '/api/projects/{projectid}/{password}/bills', 'verb' => 'PUT'],
		['name' => 'oldApi#apiDeleteBill', 'url' => '/api/projects/{projectid}/{password}/bills/{billid}', 'verb' => 'DELETE'],
		['name' => 'oldApi#apiDeleteBills', 'url' => '/api/projects/{projectid}/{password}/bills', 'verb' => 'DELETE'],
		['name' => 'oldApi#apiClearTrashbin', 'url' => '/api/projects/{projectid}/{password}/trashbin', 'verb' => 'DELETE'],
		['name' => 'oldApi#apiv2GetBills', 'url' => '/apiv2/projects/{projectid}/{password}/bills', 'verb' => 'GET'],
		['name' => 'oldApi#apiv3GetBills', 'url' => '/apiv3/projects/{projectid}/{password}/bills', 'verb' => 'GET'],
		['name' => 'oldApi#apiGetProjectStatistics', 'url' => '/api/projects/{projectid}/{password}/statistics', 'verb' => 'GET'],
		['name' => 'oldApi#apiGetProjectSettlement', 'url' => '/api/projects/{projectid}/{password}/settle', 'verb' => 'GET'],
		['name' => 'oldApi#apiAutoSettlement', 'url' => '/api/projects/{projectid}/{password}/autosettlement', 'verb' => 'GET'],
		['name' => 'oldApi#apiAddCurrency', 'url' => '/api/projects/{projectid}/{password}/currency', 'verb' => 'POST'],
		['name' => 'oldApi#apiEditCurrency', 'url' => '/api/projects/{projectid}/{password}/currency/{currencyid}', 'verb' => 'PUT'],
		['name' => 'oldApi#apiDeleteCurrency', 'url' => '/api/projects/{projectid}/{password}/currency/{currencyid}', 'verb' => 'DELETE'],
		['name' => 'oldApi#apiAddPaymentMode', 'url' => '/api/projects/{projectid}/{password}/paymentmode', 'verb' => 'POST'],
		['name' => 'oldApi#apiEditPaymentMode', 'url' => '/api/projects/{projectid}/{password}/paymentmode/{pmid}', 'verb' => 'PUT'],
		['name' => 'oldApi#apiSavePaymentModeOrder', 'url' => '/api/projects/{projectid}/{password}/paymentmode-order', 'verb' => 'PUT'],
		['name' => 'oldApi#apiDeletePaymentMode', 'url' => '/api/projects/{projectid}/{password}/paymentmode/{pmid}', 'verb' => 'DELETE'],
		['name' => 'oldApi#apiAddCategory', 'url' => '/api/projects/{projectid}/{password}/category', 'verb' => 'POST'],
