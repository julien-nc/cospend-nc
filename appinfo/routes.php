...
return [
	...
	'ocs' => [
		...
		['name' => 'api#publicEditProject', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}', 'verb' => 'PUT', 'requirements' => $requirements],
		...
		['name' => 'api#publicGetProjectSettlement', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/settlement', 'verb' => 'GET', 'requirements' => $requirements],
		['name' => 'api#autoSettlement', 'url' => '/api/{apiVersion}/projects/{projectId}/auto-settlement', 'verb' => 'GET', 'requirements' => $requirements],
		['name' => 'api#publicAutoSettlement', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/auto-settlement', 'verb' => 'GET', 'requirements' => $requirements],
		...
		['name' => 'api#publicCreateBill', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/bills', 'verb' => 'POST', 'requirements' => $requirements],
		['name' => 'api#getBills', 'url' => '/api/{apiVersion}/projects/{projectId}/bills', 'verb' => 'GET', 'requirements' => $requirements],
		['name' => 'api#publicGetBills', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/bills', 'verb' => 'GET', 'requirements' => $requirements],
		...
		['name' => 'api#publicEditBill', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/bills/{billId}', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#editBills', 'url' => '/api/{apiVersion}/projects/{projectId}/bills', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#publicEditBills', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/bills', 'verb' => 'PUT', 'requirements' => $requirements],
		...
		['name' => 'api#publicRepeatBill', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/bills/{billId}/repeat', 'verb' => 'GET', 'requirements' => $requirements],
		// members
		['name' => 'api#getMembers', 'url' => '/api/{apiVersion}/projects/{projectId}/members', 'verb' => 'GET', 'requirements' => $requirements],
		['name' => 'api#publicGetMembers', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/members', 'verb' => 'GET', 'requirements' => $requirements],
		['name' => 'api#createMember', 'url' => '/api/{apiVersion}/projects/{projectId}/members', 'verb' => 'POST', 'requirements' => $requirements],
		['name' => 'api#publicCreateMember', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/members', 'verb' => 'POST', 'requirements' => $requirements],
		...
		['name' => 'api#publicDeleteMember', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/members/{memberId}', 'verb' => 'DELETE', 'requirements' => $requirements],
		// shares
		...
		['name' => 'api#publicCreateCurrency', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/currency', 'verb' => 'POST', 'requirements' => $requirements],
		['name' => 'api#editCurrency', 'url' => '/api/{apiVersion}/projects/{projectId}/currency/{currencyId}', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#publicEditCurrency', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/currency/{currencyId}', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#deleteCurrency', 'url' => '/api/{apiVersion}/projects/{projectId}/currency/{currencyId}', 'verb' => 'DELETE', 'requirements' => $requirements],
		['name' => 'api#publicDeleteCurrency', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/currency/{currencyId}', 'verb' => 'DELETE', 'requirements' => $requirements],
		// payment modes
		['name' => 'api#createPaymentMode', 'url' => '/api/{apiVersion}/projects/{projectId}/paymentmode', 'verb' => 'POST', 'requirements' => $requirements],
		['name' => 'api#publicCreatePaymentMode', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/paymentmode', 'verb' => 'POST', 'requirements' => $requirements],
		['name' => 'api#editPaymentMode', 'url' => '/api/{apiVersion}/projects/{projectId}/paymentmode/{pmId}', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#publicEditPaymentMode', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/paymentmode/{pmId}', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#savePaymentModeOrder', 'url' => '/api/{apiVersion}/projects/{projectId}/paymentmode-order', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#publicSavePaymentModeOrder', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/paymentmode-order', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#deletePaymentMode', 'url' => '/api/{apiVersion}/projects/{projectId}/paymentmode/{pmId}', 'verb' => 'DELETE', 'requirements' => $requirements],
		['name' => 'api#publicDeletePaymentMode', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/paymentmode/{pmId}', 'verb' => 'DELETE', 'requirements' => $requirements],
		// categories
		['name' => 'api#createCategory', 'url' => '/api/{apiVersion}/projects/{projectId}/category', 'verb' => 'POST', 'requirements' => $requirements],
		['name' => 'api#publicCreateCategory', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/category', 'verb' => 'POST', 'requirements' => $requirements],
		['name' => 'api#editCategory', 'url' => '/api/{apiVersion}/projects/{projectId}/category/{categoryId}', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#publicEditCategory', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/category/{categoryId}', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#saveCategoryOrder', 'url' => '/api/{apiVersion}/projects/{projectId}/category-order', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#publicSaveCategoryOrder', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/category-order', 'verb' => 'PUT', 'requirements' => $requirements],
		['name' => 'api#deleteCategory', 'url' => '/api/{apiVersion}/projects/{projectId}/category/{categoryId}', 'verb' => 'DELETE', 'requirements' => $requirements],
		['name' => 'api#publicDeleteCategory', 'url' => '/api/{apiVersion}/public/projects/{projectId}/{password}/category/{categoryId}', 'verb' => 'DELETE', 'requirements' => $requirements],
	],
];
