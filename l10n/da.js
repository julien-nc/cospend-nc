OC.L10N.register(
    ...
    "Cospend public access" : "Cospend offentlig adgang",
    "Enter password of project %s" : "Indtast kodeord for projektet %s",
    "Enter project id and password" : "Indtast projekt id og kodeord",
    "Project %s" : "Projektet %s",
    "Access denied" : "Adgang nægtet",
    "You are not allowed to delete this project" : "Du har ikke tilladelse til at slette dette projekt",
    "You are not allowed to delete this bill" : "Du har ikke tilladelse til at slette denne regning",
    "You are not allowed to get this project's info" : "Du har ikke tilladelse til at tilgå informationer om dette projekt",
    "You are not allowed to get this project's statistics" : "Du har ikke tilladelse til at se projektets statistikker",
    "You are not allowed to get this project's settlement" : "Du har ikke tilladelse til at se projektets afregning",
    "You are not allowed to settle this project automatically" : "Du har ikke tilladelse til automatisk at afregne projektet",
    "You are not allowed to access this project" : "Du har ikke tilladelse til at tilgå dette projekt",
    "You are not allowed to edit this member" : "Du har ikke tilladelse til at redigere dette medlem",
    "You are not allowed to edit this bill" : "Du har ikke tilladelse til at redigere denne regning",
    "You are not allowed to edit this project" : "Du har ikke tilladelse til at redigere dette projekt",
    "You are not allowed to add bills" : "Du har ikke tilladelse til at tilføje regninger",
    "You are not allowed to add members" : "Du har ikke tilladelse til at tilføje medlemmer",
    "You are not allowed to get the bill list" : "Du har ikke tilladelse til at se regningerne",
    "Anonymous project creation is not allowed on this server" : "Oprettelse af anonyme projekter er ikke tilladt på denne server",
    "Project not found" : "Projektet kunne ikke findes",
    "Bad password or public link" : "Forkert kodeord eller delingslink",
    "Unauthorized action" : "Uautoriseret handling",
    "You are not allowed to manage categories" : "Du har ikke tilladelse til at administrere kategorierne",
    "You are not allowed to manage currencies" : "Du har ikke tilladelse til at administrere valutaerne",
    "You are not allowed to remove this shared access" : "Du har ikke tilladelse til at fjerne denne delte adgang",
    "You are not allowed to export this project settlement" : "Du har ikke tilladelse til at eksportere dette projekts afregning",
    "You are not allowed to export this project statistics" : "Du har ikke tilladelse til at eksportere dette projekts statistikker",
    "You are not allowed to export this project" : "Du har ikke tilladelse til at eksportere dette projekt",
    "Grocery" : "Dagligvarer",
    "Bar/Party" : "Fest",
    "Rent" : "Husleje",
    "Bill" : "Regning",
    ...
    "\"What\" field is invalid" : "\"Hvad\" feltet er ugyldigt",
    "Not found" : "Ikke fundet",
    "This project have no such category" : "Den ønskede kategori eksisterer ikke i dette projekt",
    ...
    "Malformed CSV, bad payer weight on line %1$s" : "Fejlagtig CSV, dårlig betalingsvægt på linje %1$s",
    ...
    "Malformed CSV, bad column names" : "Fejlagtig CSV, dårlige kolonnenavne",
    "Malformed CSV, no payer on line %1$s" : "Fejlagtig CSV, ingen betaler på linje %1$s",
    "daily" : "daglig",
    "weekly" : "ugentlig",
    "monthly" : "månedlig",
    "No bill yet" : "Ingen regning endnu",
    "2 active members are required to create a bill" : "2 aktive medlemmer er påkrævet for at oprette en regning",
    "Choose file" : "Vælg fil",
    "Create the bills" : "Opret regningerne",
    "Create the bill" : "Opret regningen",
    "Bill created" : "Regningen blev oprettet",
    "Failed to create bill" : "Fejl ved oprettelse af regningen",
    "Bill saved" : "Regningen blev gemt",
    ...
    "Undo" : "Fortryd",
    "Deleted bill" : "Regningen blev slettet",
    ...
    "Attach public link to personal file" : "Tilføj offentligt link til en personlig fil",
    ...
    "Monthly" : "Månedlig",
    "Yearly" : "Årlig",
    "Include all active member on repeat" : "Inkluder alle aktive medlemmer i gentagelsen",
    "Repeat until" : "Gentag indtil",
    "More details about the bill (300 char. max)" : "Flere detaljer omkring regningen (maks 300 karakterer)",
    "Bill values are not valid" : "Regningens værdier er ugyldige",
    "Invalid values" : "Ugyldige værdier",
    "Category name should not be empty" : "Kategorinavn må ikke være tomt",
    "Category icon should not be empty" : "Kategoriikon må ikke være tomt",
    "Category color should not be empty" : "Kategorifarve må ikke være tomt",
    "Failed to get project categories" : "Der skete en fejl under indhentningen af projektets kategorier",
    "Categories of project {name}" : "Kategorier af projekt {name}",
    "Add category" : "Tilføj kategori",
    "Icon" : "Ikon",
    "Name" : "Navn",
    "New category name" : "Nyt kategorinavn",
    "Color" : "Farve",
    "Add this category" : "Tilføj kategorien",
    "Category list" : "Kategoriliste",
    "Category {n} added" : "Kategorien {n} blev tilføjet",
    ...
    "Project exported in {path}" : "Projektet blev eksporteret til {path}",
    ...
    "Failed to get statistics" : "Statistikkerne kunne ikke indhentes",
    "Failed to get settlement" : "Afregningen kunne ikke indlæses",
    ...
    "MoneyBuster link/QRCode for project {name}" : "MoneyBuster link/QR Kode til projekt {name}",
    "Project password" : "Projekt kodeord",
    "Incorrect project password" : "Forkert projekt kodeord",
    ...
    "Display statistics" : "Vis statistikker",
    "Export to csv" : "Eksporter til CSV",
    "Manage currencies" : "Administrer valutaer",
    "Manage categories" : "Administrer kategorier",
    "Delete" : "Slet",
    "Press enter to validate" : "Tryk enter for at validere",
    "Allow guests to create projects" : "Tillad gæster at oprette projekter",
    "New project" : "Nyt projekt",
    "Project name" : "Projektnavn",
    "My project name" : "Mit projektnavn",
    "Password (optional, required for guest access)" : "Kodeord (valgfrit, påkrævet til gæsteadgang)",
    "Add project" : "Tilføj projekt",
    "New bill" : "Ny regning",
    "Settings" : "Indstillinger",
    "Import csv project file" : "Importer CSV projekt fil",
    "Import SplitWise project file" : "Importer SplitWise projekt fil"
},
