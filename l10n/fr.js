OC.L10N.register(
    ...
    "No such share link" : "Ce lien de partage n'existe pas",
    "Access denied" : "Accès refusé",
    "No such share link or public access" : "Ce lien de partage ou accès public n'existe pas",
    "Unauthorized action" : "Action non autorisée",
    "You are not allowed to clear the trashbin" : "Vous n'êtes pas autorisé à vider la corbeille",
    ...
    "Show deprecated password protected access" : "Afficher l'accès protégé par mot de passe (obsolète)",
    "Password protected access is now deprecated. You can use the share links instead, they can be password protected too." : "L'accès protégé par mot de passe est maintenant obsolète. Vous pouvez utiliser les liens de partage à la place, ils peuvent également être protégés par mot de passe.",
    "Password protected access" : "Accès protégé par mot de passe",
    "Set project password" : "Définir le mot de passe du projet",
