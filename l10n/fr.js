OC.L10N.register(
    "cospend",
    {
    "You have created {bill} in {project}" : "Vous avez créé {bill} dans {project}",
    "{user} has created {bill} in {project}" : "{user} a créé {bill} dans {project}",
    "You have deleted {bill} in {project}" : "Vous avez supprimé {bill} dans {project}",
    "{user} has deleted {bill} in {project}" : "{user} a supprimé {bill} dans {project}",
    "You have shared {project} with {who}" : "Vous avez partagé {project} avec {who}",
    "{user} has shared {project} with {who}" : "{user} a partagé {project} avec {who}",
    "You stopped sharing {project} with {who}" : "Vous avez cessé de partager {project} avec {who}",
    "{user} stopped sharing {project} with {who}" : "{user} a cessé de partager {project} avec {who}",
    "You have updated {bill} in {project}" : "Vous avez modifié {bill} dans {project}",
    "{user} has updated {bill} in {project}" : "{user} a modifié {bill} dans {project}",
    "A Cospend <strong>bill</strong> has been created" : "Une <strong>facture</strong> Cospend a été créée",
    "A Cospend <strong>bill</strong> has been deleted" : "Une <strong>facture</strong> Cospend a été supprimée",
    "A Cospend <strong>bill</strong> has been updated" : "Une <strong>facture</strong> Cospend a été modifiée",
    ...
    "Cospend" : "Cospend",
    "A Cospend <strong>project</strong> has been shared or unshared" : "Un partage de <strong>projet</strong> Cospend a été créé ou supprimé",
    "You are not allowed to access the target project" : "Vous n'êtes pas autorisé à accéder au projet cible",
    ...
    "{user} shared project {project} with you" : "{user} a partagé le projet {project} avec vous",
    "Cospend project share removed" : "Partage du projet Cospend supprimé",
    "{user} stopped sharing project {project} with you" : "{user} a cessé de partager le projet {project} avec vous",
    "Cospend federated project shared" : "Projet Cospend fédéré partagé",
    "%s (%s) shared Cospend project \"%s\" (%s) with you." : "%s (%s) a partagé le projet Cospend \"%s\" (%s) avec vous.",
    "Cospend bills" : "Factures Cospend",
    "in %1$s" : "dans %1$s",
    "Cospend projects" : "Projets Cospend",
    "Owned by %1$s" : "Possédé par %1$s",
    ...
    "Failed to get federated project" : "Impossible d'obtenir un projet fédéré",
    "Failed to get pending remote invitations" : "Impossible d'obtenir les invitations fédérées en attente",
    ...
    "Trash bin" : "Corbeille",
    "Search bills" : "Rechercher des factures",
    ...
    "No member" : "Aucun membre",
    "Add at least one member to start creating bills" : "Ajoutez au moins un membre pour commencer à créer des factures",
    ...
    "Global balances" : "Balances globales",
    ...
    "Payer" : "Payeur",
    "Receiver" : "Récepteur",
    "Create bill ({amount} {currencyName})" : "Créer une facture ({amount} {currencyName})",
    ...
    "Admin" : "Admin",
    "Project {projectName} ({projectId}) shared by {displayName} ({cloudId})" : "Projet {projectName} ({projectId}) partagé par {displayName} ({cloudId})",
    "Impossible to move the bill to \"{projectName}\". The payer was not found in the target project." : "Impossible de déplacer la facture vers \"{projectName}\". Le payeur n'a pas été trouvé dans le projet cible.",
    "Bill moved to \"{projectName}\" successfully" : "Facture déplacée vers \"{projectName}\" avec succès",
    "Failed to move bill from {name1} to {name2}" : "Impossible de déplacer la facture de {name1} vers {name2}",
    ...
    "My cumulated balance" : "Ma balance cumulée",
    "Pending share invitations" : "Invitations de partage en attente",
    ...
    "Show my cumulated balance" : "Afficher ma balance cumulée",
    ...
    "Project {projectName} shared by {inviterName} ({inviterCloudId})" : "Projet {projectName} partagé par {inviterName} ({inviterCloudId})",
    "Pending invitations for federated shares" : "Invitations en attente pour les partages fédérées",
    "Reject" : "Refuser",
    "Accept" : "Accepter",
    ...
    "Allow bill deletion" : "Autoriser la suppression de facture",
    ...
    "Federated share saved" : "Partage fédéré enregistré",
    ...
    "Accepted share" : "Partage accepté",
    "Label" : "Label",
    "Delete federated share" : "Supprimer le partage fédéré",
    ...
    "Total paid by all the members: {t} {currencyName}" : "Total payé par tous les membres : {t} {currencyName}",
    "Total paid by all the members: {t}" : "Total payé par tous les membres : {t}",
    "You can zoom on the line charts by holding the SHIFT key and using the mouse wheel. You can then pan the chart by dragging it with the mouse." : "Vous pouvez zoomer sur les graphiques en maintenant la touche SHIFT enfoncée et en utilisant la molette de la souris. Vous pouvez ensuite vous déplacer en les faisant glisser avec la souris.",
    "Global stats" : "Stats globales",
    "Filtered balance" : "Solde filtré",
    "This balance is computed from the complete bill list" : "Cette balance est calculée à partir de la liste complète des factures",
    "Global Balance" : "Balance globale",
    ...
    "Enable Federation in Cospend" : "Activer la Fédération en Cospend",
    "Only consider past bills to compute balances" : "Considérer uniquement les factures passées pour calculer les balances",
