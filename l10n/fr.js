OC.L10N.register(
    ...
    "In project %1$s" : "Dans le projet %1$s",
    ...
    "weekly" : "hebdomadaire",
    "monthly" : "mensuel",
    "No bill selected" : "Aucune facture sélectionnée",
    "Details" : "Infos",
    ...
    "Bill repetition process runs once a day as a background job. If your bills are not repeated, ask your Nextcloud administrator to check if \"Cron\" method is selected in admin settings." : "Le processus de répétition de factures se déclenche une fois par jour dans une tâche de fond. Si vos factures ne sont pas répétées, demandez à votre administrateur Nextcloud de vérifier si la méthode \"Cron\" est sélectionnée dans les paramètres d'administration.",
    "New bill" : "Nouvelle facture",
    "Assign category" : "Assigner une catégorie",
    "Assign payment mode" : "Assigner un mode de paiement",
    "Delete selected bills" : "Supprimer les factures sélectionnées",
    "Multi select mode: Select bills to make grouped actions" : "Mode sélection multiple : Sélectionnez les factures pour effectuer des actions groupées",
    ...
    "No categories to display" : "Aucune catégorie à afficher",
    ...
    "Currency name should not be empty." : "Le nom de devise ne doit pas être vide.",
    ...
    "Confirm project password to get a QRCode including the password." : "Confirmez le mot de passe du projet pour obtenir un QRCode incluant le mot de passe.",
    "Project password" : "Mot de passe du projet",
    "Incorrect project password." : "Mot de passe de projet incorrect.",
    "Scan this QRCode with a smartphone which has MoneyBuster or PayForMe installed or simply send the link itself." : "Scannez ce QRCode avec un smartphone qui a MoneyBuster ou PayForMe installé ou simplement envoyez le lien.",
    "As the password is stored hashed (for security), it can't be automatically included in the QRCode. If you want to include it in the QRCode and make it easier to add a project in mobile apps, you must provide the password again." : "Comme le mot de passe est stocké haché (pour la sécurité), il ne peut pas être automatiquement inclus dans le QRCode. Si vous voulez l'inclure dans le QRCode et faciliter l'ajout d'un projet dans les applications mobiles, vous devez fournir le mot de passe à nouveau.",
    "Type the project password and press \"Enter\" to generate another QRCode that includes the password." : "Tapez le mot de passe du projet et appuyez sur \"Entrée\" pour générer un autre QRCode incluant le mot de passe.",
    ...
    "Total payed by {name}" : "Total payé par {name}",
    ...
    "What kind of member is she/he?" : "Quel type de membre est-il/elle ?",
    ...
    "A member is already named like that." : "Un membre est déjà nommé comme cela.",
    ...
    "Guest link could not be copied to clipboard." : "Le lien invité n'a pas pu être copié dans le presse-papiers.",
    ...
    "Password protected access" : "Accès protégé par mot de passe",
    "New project password" : "Nouveau mot de passe du projet",
    "Link could not be copied to clipboard." : "Le lien n'a pas pu être copié dans le presse-papiers.",
    "Password should not be empty." : "Le mot de passe ne doit pas être vide.",
    "Guest access level changed." : "Le niveau d'accès invité a été modifié.",
    "Sharing" : "Partage",
    "Settings" : "Paramètres",
    "Categories" : "Catégories",
    "Currencies" : "Devises",
    "{nb} bills, {nm} active members, {ns} spent" : "{nb} factures, {nm} membres actifs, {ns} dépensés",
    ...
    "Failed to save Cospend setting." : "Impossible d'enregistrer les paramètres de Cospend.",
    ...
    "Failed to check password." : "Échec de la vérification du mot de passe.",
