OC.L10N.register(
    ...
    "{user} shared project {project} with you" : "{user} compartiu o proxecto {project} con Vde.",
    "Cospend project share removed" : "Retirouse a compartición do proxecto de Cospend",
    "{user} stopped sharing project {project} with you" : "{user} deixou de compartir o proxecto {project} con Vde.",
    ...
    "Project {projectName} ({projectId}) shared by {displayName} ({cloudId})" : "Proxecto {projectName} ({projectId}) compartido por {displayName} ({cloudId})",
    "Everyone" : "Todos",
    ...
    "Pick current directory" : "Seleccionar o directorio actual",
    ...
    "Only consider past bills to compute balances" : "Ter en conta só as facturas anteriores para calcular os saldos",
