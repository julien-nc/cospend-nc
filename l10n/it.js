OC.L10N.register(
    ...
    "Monthly" : "Mensile",
    "Yearly" : "Annualmente",
    "Include all active member on repeat" : "Includi tutti i membri attivi alla ripetizione",
    ...
    "Category name should not be empty" : "Il nome della categoria non deve essere vuoto",
    "Category icon should not be empty" : "L'icona della categoria non deve essere vuota",
    "Category color should not be empty" : "La categoria non deve essere vuota",
    "Failed to get project categories" : "Impossibile ottenere le categorie del progetto",
    "Categories of project {name}" : "Categorie del progetto {name}",
    "Add category" : "Aggiungi categoria",
    "Icon" : "Icone",
    "Color" : "Colore",
    "Add this category" : "Aggiungi questa categoria",
    "Category list" : "Elenco categorie",
    "Category {n} added" : "Categoria {n} aggiunta",
    ...
    "Admin: edit/delete project + maintener permissions" : "Admin: modifica/elimina progetto + autorizzazioni di manutentore",
    "Maintener: add/edit members/categories/currencies + participant permissions" : "Manutentore: aggiungi/modifica membri/categorie/valute + permessi per i partecipanti",
    "Participant: add/edit/delete bills + viewer permissions" : "Partecipante: aggiungi/modifica/elimina spese + permessi visualizzatore",
    "Viewer" : "Visualizzatore",
    "Public share link" : "Link di condivisione pubblica",
    ...
    "What kind of member is \"{m}\"?" : "Che tipo di membro è \"{m}\"?",
    "Who paid for category \"{c}\"?" : "Chi ha pagato per la categoria \"{c}\"?",
    "Public link copied to clipboard" : "Link pubblico copiato negli appunti",
    "Project {pname} is now shared with {uname}" : "Il progetto {pname} è ora condiviso con {uname}",
    ...
    "Public access link added for project {pname}" : "Link di accesso pubblico aggiunto per il progetto {pname}",
    "Failed to add public share" : "Impossibile aggiungere la condivisione pubblica",
    "Failed to delete public share" : "Impossibile eliminare la condivisione pubblica",
    "Project {pname} is now shared with group {gname}" : "Il progetto {pname} è ora condiviso con il gruppo {gname}",
    "Failed to add group share" : "Impossibile aggiungere la condivisione gruppo",
    "Participant" : "Partecipante",
    "Maintener" : "Manutentore",
    "Admin" : "Amministratore",
    "Shared access deleted" : "Accesso condiviso eliminato",
    "Failed to delete group share" : "Impossibile eliminare la condivisione gruppo",
    "Failed to edit share access level" : "Impossibile modificare il livello di accesso condiviso",
    ...
    "Password (optional, required for guest access)" : "Password (opzionale, richiesta per l'accesso degli ospiti)",
    "Add project" : "Aggiungi progetto",
    "New bill" : "Nuova spesa",
    "Settings" : "Impostazioni",
    "Import csv project file" : "Importa file di progetto csv",
    "Import SplitWise project file" : "Importa file di progetto SplitWise",
